...
namespace hpx { namespace traits
{
    ...
    struct has_decorates_action
      : detail::has_decorates_action<typename std::decay<Component>::type>
    {};
    ...
    struct action_decorate_function
    {
        static constexpr bool value =
            has_decorates_action<typename Action::component_type>::value;
    ...
    {
        static constexpr bool value = has_decorates_action<Component>::value;
